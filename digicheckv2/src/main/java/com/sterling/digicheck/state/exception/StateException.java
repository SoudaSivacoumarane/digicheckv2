package com.sterling.digicheck.state.exception;

import com.sterling.common.exception.DigiCheckException;

public class StateException extends DigiCheckException {
	...
	public StateException(Exception exception, String level, String action){
		super(exception);
		this.level = level;
		this.action = action;
	}
	...
	/** Inicialitation User Exception with Level code and Action Code */
	public StateException(String customError, String level, String action){
		super(customError);
