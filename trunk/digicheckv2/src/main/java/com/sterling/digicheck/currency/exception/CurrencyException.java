package com.sterling.digicheck.currency.exception;

import com.sterling.common.exception.DigiCheckException;

public class CurrencyException extends DigiCheckException {
	...
	private static final String MODULE_EXCEPTION_CODE = "11";//$NON-NLS-1$
	
	/** Inicialitation User Exception with Level code and Action Code */
	public CurrencyException(Exception exception, String level, String action){
		super(exception);
		this.level = level;
		this.action = action;
	}
	...
	/** Inicialitation User Exception with Level code and Action Code */
	public CurrencyException(String customError, String level, String action){
		super(customError);
