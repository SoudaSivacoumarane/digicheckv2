package com.sterling.digicheck.user.exception;

import com.sterling.common.exception.DigiCheckException;

public class UserException extends DigiCheckException {
	...
	public UserException(Exception exception, String level, String action){
		super(exception);
		this.level = level;
		this.action = action;
	}
	...
	/** Inicialitation User Exception with Level code and Action Code */
	public UserException(String customError, String level, String action){
		super(customError);
