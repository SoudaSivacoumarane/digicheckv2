...
/**
 * Utilerias para formateo de numeros
 * @author Jos� Delgado Rguez
 * @date 2009-11-10
 */
...
public class NumberUtil {
	...
	private final static String tonPattern = "###,###,##0.000";//$NON-NLS-1$
	...
	/** Clase que formatea las toneladas */
	private static DecimalFormat tonFormater = new DecimalFormat(tonPattern);
	...
	public static String convertTon( double tons ){
		String formatedTon =  null;
		formatedTon = tonFormater.format(tons);
		return formatedTon;
	}
